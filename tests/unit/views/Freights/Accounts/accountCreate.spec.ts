...
describe('FreightAccountCreate.vue', () => {
    beforeEach(async () => {
        ...
        router.push(`/freights/${freight.id}/accounts/create`);
        await router.isReady();
    });

    it('renders freight account create vue', async () => {
        ...
        const wrapper = mount(FreightAccountCreate, {
            global: {
        ...
        expect(accountStore.setNewAccountAttrs).toHaveBeenCalledWith({
            freightId: 1,
